...
export const USER_RESERVATION_FACILITY_ID_FIELD_CONFIG_UPDATED = SN_USER + '/RESERVATION_FACILITY_ID_FIELD_CONFIG_UPDATED'
export const USER_IS_EXTERNAL = SN_USER + '/IS_EXTERNAL_UPDATED'
