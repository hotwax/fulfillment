...
const persistState = createPersistedState({
    paths: ['user', 'util.productStoreShipmentMethCount', 'util.isForceScanEnabled', 'util.picklistItemIdentificationPref', 'util.isPicklistDownloadEnabled', 'util.barcodeIdentificationPref', 'util.carrierDesc', 'util.facilityAddresses', 'product.sampleProducts'],
    fetchBeforeUse: true
})
